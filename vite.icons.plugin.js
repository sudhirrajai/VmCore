  ...
  return {
    ...
    async buildStart() {
      ...
      try {
        ...
        // Output to resources/assets/admin/ to match project structure
        const outputPath = path.resolve(process.cwd(), 'resources/assets/admin/vendor/fonts/iconify/iconify.css');
