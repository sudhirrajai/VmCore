                ...
                <form action="{{ route('admin.social-links.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3"><label class="form-label">Platform <span
                                ...
                                name="platform" value="{{ old('platform') }}" placeholder="e.g. Facebook, Twitter" required>
                        </div>
                    ...
                    <a href="{{ route('admin.social-links.index') }}" class="btn btn-outline-secondary ms-2">Cancel</a>
                </form>
            </div>
        </div>
    </div>
