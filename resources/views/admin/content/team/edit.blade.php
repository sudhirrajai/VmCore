                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <select name="meta_robots" id="meta_robots" class="form-select">
                                <option value="" {{ old('meta_robots', $member->meta_robots ?? '') == '' ? 'selected' : '' }}>Default (Global Setting)</option>
                                <option value="INDEX,FOLLOW" {{ old('meta_robots', $member->meta_robots ?? '') == 'INDEX,FOLLOW' ? 'selected' : '' }}>Index, Follow</option>
                                <option value="NOINDEX,FOLLOW" {{ old('meta_robots', $member->meta_robots ?? '') == 'NOINDEX,FOLLOW' ? 'selected' : '' }}>Noindex, Follow</option>
                                <option value="NOINDEX,NOFOLLOW" {{ old('meta_robots', $member->meta_robots ?? '') == 'NOINDEX,NOFOLLOW' ? 'selected' : '' }}>Noindex, Nofollow</option>
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea class="form-control" name="meta_description" rows="2">{{ old('meta_description', $member->meta_description ?? '') }}</textarea>
                        </div>
                    </div>
