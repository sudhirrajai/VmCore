    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.services.create') }}" class="btn btn-primary"><i class="bx bx-plus me-1"></i> Add
                    Service</a>
            </div>
                        ...
                        <tbody>
                            @forelse($items as $item)
                                <tr>
                                    ...
                                    <td>
                                        @if($item->image)
                                            <img src="{{ asset($item->image) }}" class="rounded" width="50" height="50"
                                    ...
                                    <td>{{ $item->order }}</td>
                                    <td>@include('admin.content._partials.status-toggle', ['item' => $item, 'route' => 'admin.services.toggle-status'])
                                    </td>
                                    <td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center py-4 text-muted">No services found. <a
                                            href="{{ route('admin.services.create') }}">Create one</a></td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
