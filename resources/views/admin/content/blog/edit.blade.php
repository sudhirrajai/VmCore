                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <select name="meta_robots" id="meta_robots" class="form-select">
                                <option value="" {{ old('meta_robots', $post->meta_robots) == '' ? 'selected' : '' }}>Default (Global Setting)</option>
                                <option value="INDEX,FOLLOW" {{ old('meta_robots', $post->meta_robots) == 'INDEX,FOLLOW' ? 'selected' : '' }}>Index, Follow</option>
                                <option value="NOINDEX,FOLLOW" {{ old('meta_robots', $post->meta_robots) == 'NOINDEX,FOLLOW' ? 'selected' : '' }}>Noindex, Follow</option>
                                <option value="NOINDEX,NOFOLLOW" {{ old('meta_robots', $post->meta_robots) == 'NOINDEX,NOFOLLOW' ? 'selected' : '' }}>Noindex, Nofollow</option>
                            </select>
                            <div class="form-text small">Override the global search engine visibility for this specific blog post.</div>
                        </div>
