                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="meta_robots" id="meta_robots" class="form-select">
                                        <option value="" {{ old('meta_robots', $page->meta_robots) == '' ? 'selected' : '' }}>Default (Global Setting)</option>
                                        <option value="INDEX,FOLLOW" {{ old('meta_robots', $page->meta_robots) == 'INDEX,FOLLOW' ? 'selected' : '' }}>Index, Follow</option>
                                        <option value="NOINDEX,FOLLOW" {{ old('meta_robots', $page->meta_robots) == 'NOINDEX,FOLLOW' ? 'selected' : '' }}>Noindex, Follow</option>
                                        <option value="NOINDEX,NOFOLLOW" {{ old('meta_robots', $page->meta_robots) == 'NOINDEX,NOFOLLOW' ? 'selected' : '' }}>Noindex, Nofollow</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="faq_schema_script" id="faq_schema_script" class="form-control font-monospace"
                                        rows="4" placeholder='<script type="application/ld+json">...</script>'>{{ old('faq_schema_script', $page->faq_schema_script) }}</textarea>
