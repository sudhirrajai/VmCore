...
<section class="container-custom pt-20 pb-12 px-8 text-center max-w-4xl mx-auto animate-fade-in-up">
    <span class="text-sm font-medium text-secondary uppercase tracking-widest block mb-4">{!! setting('about_hero_label', 'About Us') !!}</span>
    <h1 class="text-5xl lg:text-7xl font-bold leading-tight mb-6 text-slate-900">{!! setting('about_hero_title', 'Our Story') !!}</h1>
...
<section class="container-custom pb-20" aria-label="About Hero Image">
    <div class="relative aspect-[16/9] lg:aspect-[21/9] rounded-2xl overflow-hidden shadow-2xl animate-fade-in-up delay-200 w-full">
        <img 
...
<section class="container-custom py-12" aria-label="Leadership Team">
  <div class="mb-12">
    <span class="text-sm font-medium text-secondary uppercase tracking-widest">{!! setting('about_leadership_label', 'Our Leadership') !!}</span>
    <h2 class="text-2xl lg:text-4xl font-semibold leading-tight mt-2 mb-6 text-slate-900">{!! setting('about_leadership_heading', 'Our Leadership') !!}</h2>
  </div>
        ...
        <div class="group animate-on-scroll">
          <div class="aspect-[3/4] rounded-xl overflow-hidden mb-6 bg-gray-100 relative">
            <img 
              ...
              alt="{{ $member->name }} - {{ $member->designation ?? $member->role }}" 
    ...
    @else
        ...
        <div class="group animate-on-scroll">
          <div class="aspect-[3/4] rounded-xl overflow-hidden mb-6 bg-gray-100">
            <img src="https://picsum.photos/seed/alex-chen-portrait/600/800" alt="Alex Chen - CEO & Founder" class="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500" loading="lazy" />
          </div>
        ...
        <div class="group animate-on-scroll delay-100">
          <div class="aspect-[3/4] rounded-xl overflow-hidden mb-6 bg-gray-100">
            <img src="https://picsum.photos/seed/sarah-johnson-portrait/600/800" alt="Sarah Johnson - Head of Strategy" class="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500" loading="lazy" />
          </div>
        ...
        <div class="group animate-on-scroll delay-200">
          <div class="aspect-[3/4] rounded-xl overflow-hidden mb-6 bg-gray-100">
            <img src="https://picsum.photos/seed/david-lee-portrait/600/800" alt="David Lee - Creative Director" class="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500" loading="lazy" />
          </div>
...
<section class="container-custom py-12" aria-label="Core Values">
  <div class="mb-12">
    <span class="text-sm font-medium text-secondary uppercase tracking-widest">{!! setting('about_values_label', 'Core Values') !!}</span>
    <h2 class="text-2xl lg:text-4xl font-semibold leading-tight mt-2 mb-6 text-slate-900">{!! setting('about_values_heading', 'Core Values') !!}</h2>
  </div>
  <div class="grid md:grid-cols-3 gap-6">
    <div class="about-card bg-card p-10 rounded-xl shadow-sm border border-gray-100 animate-on-scroll">
      ...
      <h3 class="text-xl lg:text-2xl font-semibold mb-4 text-slate-900">{!! setting('about_value_1_title', 'Innovation') !!}</h3>
      <p class="text-base leading-relaxed text-slate-500">{!! setting('about_value_1_description', 'Pushing boundaries with creative solutions and cutting-edge technology to deliver exceptional results.') !!}</p>
    </div>
    ...
    <div class="about-card bg-card p-10 rounded-xl shadow-sm border border-gray-100 animate-on-scroll delay-100">
      ...
      <h3 class="text-xl lg:text-2xl font-semibold mb-4 text-slate-900">{!! setting('about_value_2_title', 'Integrity') !!}</h3>
      <p class="text-base leading-relaxed text-slate-500">{!! setting('about_value_2_description', 'Building trust through transparent communication, honest partnerships, and delivering on our promises.') !!}</p>
    </div>
    ...
    <div class="about-card bg-card p-10 rounded-xl shadow-sm border border-gray-100 animate-on-scroll delay-200">
      ...
      <h3 class="text-xl lg:text-2xl font-semibold mb-4 text-slate-900">{!! setting('about_value_3_title', 'Impact') !!}</h3>
      <p class="text-base leading-relaxed text-slate-500">{!! setting('about_value_3_description', 'Creating measurable results that drive growth and make a meaningful difference for your business.') !!}</p>
    </div>
  </div>
</section>

<!-- Stats Section -->
<section class="container-custom py-12 grid grid-cols-1 md:grid-cols-3 gap-12 text-center" aria-label="Company Statistics">
