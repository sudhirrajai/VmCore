            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <aside class="service-sidebar custom-sidebar">
                        ...
                        <div class="widget custom-widget-box">
                            <h4 class="widget_title custom-widget-title">{!! setting('sidebar_help_title', 'Need Help?') !!}
                            </h4>
                            <div class="sidebar-contact">
                                ...
                                @if(!empty($siteSettings['site_email']))
                                    <p><i class="fas fa-envelope"></i> <a
                                            href="mailto:{{ $siteSettings['site_email'] }}">{{ $siteSettings['site_email'] }}</a>
                                    </p>
                                @endif
                            </div>
                        </div>
                        @if($service->tags && $service->tags->count())
                            <div class="widget custom-widget-box">
                                <h4 class="widget_title custom-widget-title">{!! setting('service_tags_title', 'Tags') !!}
                                </h4>
